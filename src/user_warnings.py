...
async def send_warning(user: User, channel, warning_text: str, log_text: str = ""):
...
async def send_esi_permission_warning(character: Character, channel, preston: Preston):
...
async def send_structure_permission_warning(character: Character, channel, authed_preston: Preston):
...
async def send_structure_corp_warning(character: Character, channel, authed_preston: Preston):
...
async def send_channel_warning(user, channel):
    ...
    await send_warning(user, channel, warning_text, log_text=f"channel_warning for {user}")
