...
async def revoke(interaction: Interaction, character_name: str | None = None):
    ...
    if character_name is None:
        ...
        await interaction.response.send_message(f"Successfully revoked access to all your characters.")
        ...
        try:
            ...
            if character:
                character.delete_instance()
                await interaction.response.send_message(f"Successfully removed {character_name}.")
            else:
                await interaction.response.send_message("You have no character named {character_name} linked.")
...
@app_commands.describe(
    text="Name of the character to revoke, revoke all if empty."
)
@command_error_handler
